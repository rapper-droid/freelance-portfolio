  ...
  return (
    ...
    >
      <div className="works-lead-intro">
        ...
        <p>
          問い合わせ、日程調整、毎週の集計。いま使っている道具をつなぎ、
          繰り返す作業を先に進めます。すべてが一クリックで終わるわけではありません。
          初期設定と、人に残る判断がどこかは、下に書いています。
        </p>
      ...
      <div className="works-lead-state">
        ...
        <ul>
          <li>
            <b>通常プログラム</b>
            ：稼働中。日時の判定、空き確認、集計、重複判定、数式注入の防止は
            すべて実際のコードが実行しています。
          </li>
          <li>
            <b>実AI処理</b>：
        ...
        <p className="works-lead-fineprint">
          自主制作の検証であり、顧客導入の実績ではありません。稼働件数・精度・
          売上改善の数値は掲載していません。
        </p>
      </div>
      ...
      <div className="works-lead-savings">
        <h3>自分の場合で試算する</h3>
        <p>
          入力した条件での計算です。体験で計測した値ではなく、導入後の成果を
          保証するものでもありません。
        </p>
        <SavingsCalculator />
      </div>
