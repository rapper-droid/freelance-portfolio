    ...
    <>
      <section className="forme-hero">
        <div className="forme-hero-copy">
          ...
          <p>
            {
              "毎日使うものだけを、選べるだけの数で。色とサイズを選ぶと、写真も価格も在庫もその組み合わせのものに変わります。"
            }
          </p>
      ...
      <section className="forme-section" aria-labelledby="forme-do">
        ...
        <ul className="forme-do-grid">
          ...
          <li>
            ...
            <p>
              {
                "カートから受け取り方法を選び、送料まで確認して確定します。支払はシミュレーターで、承認・拒否・保留も試せます。"
              }
            </p>
          ...
          <li>
            ...
            <p>
              {
                "在庫の増減、取り扱いの停止、注文の進行と売上。客側の画面と同じ記録を動かせます。"
              }
            </p>
        ...
        <dl className="forme-info-grid">
          ...
          <div>
            ...
            <dd>
              ...
              <small>
                {
                  "条件・期限・併用・上限まで実装していないものを、画面にだけ置かないためです。"
                }
              </small>
            </dd>
          </div>
