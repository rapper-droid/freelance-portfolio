...
// hard-coded host would go stale at exactly the moment the domain moves.
...
<text x="118" y="65" font-size="19" font-weight="600" letter-spacing="1">${BRAND_NAME}</text>
...
<text x="1000" y="600" font-size="12" fill="#a6aaa2">${siteHost}</text>
</g></svg>`;
